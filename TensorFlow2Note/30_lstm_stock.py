...
"""
@Filename: 30_lstm_stock.py
@Function: TensroFlow2 API tf.keras 实现 LSTM  对股票的开盘价进行预测
@Python Version: 3.8
@Author: Wei Li
@Date：2021-06
@Usage: $ python 30_lstm_stock.py 
"""
...
# 断点续练模型
# ----------------------------------------------------------
checkpoint_save_path = r"./checkpoint/LSTM_stock/LSTM_stock.ckpt"
...
weight_txt = os.path.join(csv_file, "LSTM_stock.txt")
