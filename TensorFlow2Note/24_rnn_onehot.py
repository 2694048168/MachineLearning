...
"""
@Filename: 24_rnn_onehot.py
@Function: TensroFlow2 API tf.keras 实现 RNN 对字母进行预测
@Python Version: 3.8
@Author: Wei Li
@Date：2021-06
@Usage: $ python 24_rnn_onehot.py 
"""
...
x_train = [id_to_onehot[word_to_id['a']], 
...
# 断点续练模型
# ----------------------------------------------------------
checkpoint_save_path = r"./checkpoint/rnn_onehot/rnn_onehot.ckpt"
...
weight_txt = os.path.join(csv_file, "rnn_onehot.txt")
