...
"""
@Filename: 29_rnn_stock.py
@Function: TensroFlow2 API tf.keras 实现 RNN 对股票的开盘价进行预测
@Python Version: 3.8
@Author: Wei Li
@Date：2021-06
@Usage: $ python 29_rnn_stock.py 
"""
...
# 断点续练模型
# ----------------------------------------------------------
checkpoint_save_path = r"./checkpoint/rnn_stock/rnn_stock.ckpt"
...
weight_txt = os.path.join(csv_file, "rnn_stock.txt")
